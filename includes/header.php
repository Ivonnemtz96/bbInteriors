<!-- Main Header-->
<header id="home" class="main-header header-style-seven">
        ...
        <nav class="menu-box">
            ...
            <ul class="contact-list-one">
                <li>
                    ...
                    <span class="title">Marcános</span>
                    <div class="text"><a href="tel:1234567890">+52 123 456 7890</a></div>
                </li>
                <li>
                    <i class="icon lnr-icon-envelope1"></i>
                    <span class="title">Correo</span>
                    <div class="text"><a href="mailto:info@bbinteriors.com">info@bbinteriors.com</a></div>
                </li>
                <li>
                    <i class="icon lnr-icon-map-marker"></i>
                    <span class="title">Dirección</span>
                    <div class="text">Plaza del Mar, Zona Hotelera, 23405</div>
                </li>
            </ul>
